...
It allows withdrawMoney and has a single functionality in accordance with SOLID Principles
 */

public class Withdraw {
    public boolean withdrawMoney(long accountNumber, double amount, String amountCurrency){
        ...
        return account.withdrawMoney(amountInUSD);
    }
}
